...
(function () {
  ...
  var READY_MADE = {
    all: { file: 'Both-Books.pdf', label: 'Both books', pages: 260 },
    one: { file: 'Hive-and-Hearth-Recipes.pdf', label: 'One book', pages: 252 },
    1: { file: 'Run-and-Not-Be-Weary.pdf', label: 'Run and Not Be Weary', pages: 104, booklet: true },
    2: { file: 'Around-the-Table.pdf', label: 'Around the Table', pages: 156, booklet: true }
  };
